...
public partial class TurnosDb2Context : DbContext
  {
  public TurnosDb2Context()
    {
    }

  public TurnosDb2Context(DbContextOptions<TurnosDb2Context> options)
      : base(options)
    {
    }
  ...
  protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
      => optionsBuilder.UseSqlServer("Data Source=DESKTOP-KRJ7FGV\\SQLEXPRESS03;Initial Catalog=turnos_db_2;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
